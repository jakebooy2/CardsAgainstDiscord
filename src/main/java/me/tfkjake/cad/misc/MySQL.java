...
public class MySQL {
    ...
    private final CardsAgainstDiscord cardsAgainstDiscord;
    ...
    public MySQL(CardsAgainstDiscord cardsAgainstDiscord) {
        this.cardsAgainstDiscord = cardsAgainstDiscord;
        host = cardsAgainstDiscord.getProperties().getString("mysql_host");
        username = cardsAgainstDiscord.getProperties().getString("mysql_username");
        password = cardsAgainstDiscord.getProperties().getString("mysql_password");
        database = cardsAgainstDiscord.getProperties().getString("mysql_database");
        port = cardsAgainstDiscord.getProperties().getInt("mysql_port");
    }
